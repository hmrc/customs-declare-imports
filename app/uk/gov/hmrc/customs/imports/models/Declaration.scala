...
case class DeclarationAction(dateTimeSent: DateTime, notifications: Seq[DeclarationNotification] = Seq.empty)
...
object Declaration {
  implicit val dateTimeWrites = Writes.dateWrites("yyyy-MM-dd'T'HH:mm:ss'Z'")
